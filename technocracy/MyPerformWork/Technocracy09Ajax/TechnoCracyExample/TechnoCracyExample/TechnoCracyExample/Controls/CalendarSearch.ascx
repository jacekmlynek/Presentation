<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CalendarSearch.ascx.cs" Inherits="TechnoCracyExample.Controls.CalendarSearch" %>
<%@ Register Src="~/Controls/CalendarPriceCell.ascx" TagPrefix="cc" TagName="PriceCell" %>
                    ...
                    <tr>
                        ...
                        <asp:Repeater ID="PriceRp" runat="server" DataSource='<%# RetDateRange%>'
                         OnItemDataBound ="PriceRp_OnItemDataBound">
                            <ItemTemplate>
                                <cc:PriceCell ID="CalednarPriceCellCrt" runat="server"
                               OnCalendarChangeSelecteFlight="PriceCell_CalendarChangeSelecteFlight" />
                            </ItemTemplate>
                        </asp:Repeater>
                        <td class="margin">&nbsp;</td>
                    </tr>
